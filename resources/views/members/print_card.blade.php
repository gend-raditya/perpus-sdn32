...
<head>
    ...
    <style>
        @media print {
            ...
            /* Paksa browser untuk mencetak warna background */
            * {
    ...
    <div class="card">
        ...
        <div class="content">
            ...
            <div class="info-section">
                ...
                <p style="margin-top: 10px; font-style: italic; color: #666;">Silakan bawa kartu ini setiap melakukan
                    peminjaman buku.</p>
            </div>
        </div>
        <div class="footer">
